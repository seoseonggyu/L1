...
#include "L1AssetData.generated.h"
...
UCLASS(Const, CollapseCategories, meta=(DisplayName="L1 Asset Data"))
class UL1AssetData : public UPrimaryDataAsset
{
	GENERATED_BODY()

public:
	static const UL1AssetData& Get();
