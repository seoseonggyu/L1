...
#include UE_INLINE_GENERATED_CPP_BY_NAME(L1AssetData)

const UL1AssetData& UL1AssetData::Get()
{
	return ULyraAssetManager::Get().GetAssetData();
}

#if WITH_EDITOR
void UL1AssetData::PreSave(FObjectPreSaveContext ObjectSaveContext)
{
...
EDataValidationResult UL1AssetData::IsDataValid(FDataValidationContext& Context) const
{
...
FSoftObjectPath UL1AssetData::GetAssetPathByName(const FName& AssetName) const
{
...
const FAssetSet& UL1AssetData::GetAssetSetByLabel(const FName& Label) const
{
