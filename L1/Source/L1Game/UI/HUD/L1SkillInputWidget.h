...
#include "L1SkillInputWidget.generated.h"
...
UCLASS()
class UL1SkillInputWidget : public UUserWidget
{
	GENERATED_BODY()
	
public:
	UL1SkillInputWidget(const FObjectInitializer& ObjectInitializer = FObjectInitializer::Get());
