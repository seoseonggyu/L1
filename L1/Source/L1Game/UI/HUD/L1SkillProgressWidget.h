...
#include "L1SkillProgressWidget.generated.h"
...
UCLASS()
class UL1SkillProgressWidget : public UUserWidget
{
	GENERATED_BODY()
	
public:
	UL1SkillProgressWidget(const FObjectInitializer& ObjectInitializer = FObjectInitializer::Get());
