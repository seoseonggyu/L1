...
#include "L1SkillIconWidget.generated.h"
...
UCLASS()
class UL1SkillIconWidget : public UUserWidget
{
	GENERATED_BODY()
	
public:
	UL1SkillIconWidget(const FObjectInitializer& ObjectInitializer = FObjectInitializer::Get());
