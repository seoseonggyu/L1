#include "L1SkillProgressWidget.h"
...
#include UE_INLINE_GENERATED_CPP_BY_NAME(L1SkillProgressWidget)

UL1SkillProgressWidget::UL1SkillProgressWidget(const FObjectInitializer& ObjectInitializer)
	: Super(ObjectInitializer)
{
    
}

void UL1SkillProgressWidget::NativeConstruct()
{
...
void UL1SkillProgressWidget::NativeDestruct()
{
	UGameplayMessageSubsystem& MessageSubsystem = UGameplayMessageSubsystem::Get(this);
...
void UL1SkillProgressWidget::NativeTick(const FGeometry& MyGeometry, float InDeltaTime)
{
...
void UL1SkillProgressWidget::ConstructUI(FGameplayTag Channel, const FSkillProgressInitializeMessage& Message)
{
...
void UL1SkillProgressWidget::RefreshUI(FGameplayTag Channel, const FSkillProgressRefreshMessage& Message)
{
	if (GetVisibility() == ESlateVisibility::Visible)
	{
		ProgressBar_SkillProgress->SetFillColorAndOpacity(Message.PhaseColor);
