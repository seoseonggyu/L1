...
#include "L1ItemEntryWidget.generated.h"
...
UCLASS()
class UL1ItemEntryWidget : public UUserWidget
{
	GENERATED_BODY()
	
public:
	UL1ItemEntryWidget(const FObjectInitializer& ObjectInitializer = FObjectInitializer::Get());
...
public:
	void RefreshUI(UL1ItemInstance* NewItemInstance, int32 NewItemCount);
...
protected:
	...
	UPROPERTY()
	TObjectPtr<UL1ItemHoverWidget> HoverWidget;
