#include "L1HoverWidget.h"

#include "Components/CanvasPanel.h"
#include "Components/CanvasPanelSlot.h"
#include "Components/HorizontalBox.h"

#include UE_INLINE_GENERATED_CPP_BY_NAME(L1HoverWidget)

UL1HoverWidget::UL1HoverWidget(const FObjectInitializer& ObjectInitializer)
	: Super(ObjectInitializer)
{
    
}

void UL1HoverWidget::SetPosition(const FVector2D& AbsolutePosition)
{
