#include "L1GameplayAbility_Skill_Targeting.h"
...
#include "AbilitySystem/L1GameplayAbilityTargetActor_LineTraceHighlight.h"
#include "Actors/L1EquipmentBase.h"
#include "Character/LyraCharacter.h"
#include "GameFramework/GameplayMessageSubsystem.h"
#include "UI/HUD/L1SkillInputWidget.h"

#include UE_INLINE_GENERATED_CPP_BY_NAME(L1GameplayAbility_Skill_Targeting)

UL1GameplayAbility_Skill_Targeting::UL1GameplayAbility_Skill_Targeting(const FObjectInitializer& ObjectInitializer)
...
void UL1GameplayAbility_Skill_Targeting::ActivateAbility(const FGameplayAbilitySpecHandle Handle, const FGameplayAbilityActorInfo* ActorInfo, const FGameplayAbilityActivationInfo ActivationInfo, const FGameplayEventData* TriggerEventData)
{
...
void UL1GameplayAbility_Skill_Targeting::EndAbility(const FGameplayAbilitySpecHandle Handle, const FGameplayAbilityActorInfo* ActorInfo, const FGameplayAbilityActivationInfo ActivationInfo, bool bReplicateEndAbility, bool bWasCancelled)
{
	ResetSkill();
...
void UL1GameplayAbility_Skill_Targeting::CancelSkill()
{
	ResetSkill();
...
void UL1GameplayAbility_Skill_Targeting::ResetSkill()
{
...
void UL1GameplayAbility_Skill_Targeting::OnCastStartBegin(FGameplayEventData Payload)
{
	FGameplayCueParameters Parameters;
...
void UL1GameplayAbility_Skill_Targeting::OnMontageFinished()
{
	EndAbility(CurrentSpecHandle, CurrentActorInfo, CurrentActivationInfo, true, false);
}

void UL1GameplayAbility_Skill_Targeting::OnInputConfirm()
{
	ConfirmTaskByInstanceName(TEXT("TargetDataTask"), true);
}

void UL1GameplayAbility_Skill_Targeting::OnInputCancel()
{
	CancelSkill();
}
