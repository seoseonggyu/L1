...
#include "L1GameplayAbility_Skill_AOE.generated.h"
...
UCLASS()
class UL1GameplayAbility_Skill_AOE : public UL1GameplayAbility_Equipment
{
	GENERATED_BODY()
	
public:
	UL1GameplayAbility_Skill_AOE(const FObjectInitializer& ObjectInitializer = FObjectInitializer::Get());
...
protected:
	UPROPERTY(EditDefaultsOnly, Category="L1|AOE", meta=(Categories="GameplayCue"))
	FGameplayTag CastGameplayCueTag;
	
	UPROPERTY(EditDefaultsOnly, Category="L1|AOE", DisplayName="AOE Spawner Class")
...
protected:
	...
	UPROPERTY(EditDefaultsOnly, BlueprintReadOnly, Category="L1|AOE", DisplayName="AOE Reticle Class")
