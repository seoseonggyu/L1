#include "L1ActivateAbilitiesGameplayEffectComponent.h"
...
#include UE_INLINE_GENERATED_CPP_BY_NAME(L1ActivateAbilitiesGameplayEffectComponent)

#define LOCTEXT_NAMESPACE "ActivateAbilitiesGameplayEffectComponent"

UL1ActivateAbilitiesGameplayEffectComponent::UL1ActivateAbilitiesGameplayEffectComponent()
{
...
bool UL1ActivateAbilitiesGameplayEffectComponent::OnActiveGameplayEffectAdded(FActiveGameplayEffectsContainer& ActiveGEContainer, FActiveGameplayEffect& ActiveGE) const
{
...
void UL1ActivateAbilitiesGameplayEffectComponent::OnActiveGameplayEffectRemoved(const FGameplayEffectRemovalInfo& RemovalInfo, FActiveGameplayEffectsContainer* ActiveGEContainer) const
{
...
void UL1ActivateAbilitiesGameplayEffectComponent::OnGameplayEffectApplied(FActiveGameplayEffectsContainer& ActiveGEContainer, FGameplayEffectSpec& GESpec, FPredictionKey& PredictionKey) const
{
	UAbilitySystemComponent* ASC = ActiveGEContainer.Owner;
	if (ensure(ASC) == false)
		return;
...
#if WITH_EDITOR
EDataValidationResult UL1ActivateAbilitiesGameplayEffectComponent::IsDataValid(class FDataValidationContext& Context) const
{
