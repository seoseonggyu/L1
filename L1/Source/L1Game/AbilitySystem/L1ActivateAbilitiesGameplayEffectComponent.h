...
#include "L1ActivateAbilitiesGameplayEffectComponent.generated.h"
...
class UL1ActivateAbilitiesGameplayEffectComponent : public UGameplayEffectComponent
{
	GENERATED_BODY()
	
public:
	UL1ActivateAbilitiesGameplayEffectComponent();
