#include "L1VitalSet.h"

#include "L1GameplayTags.h"
#include "AbilitySystem/Attributes/L1AttributeSet.h"
...
#include UE_INLINE_GENERATED_CPP_BY_NAME(L1VitalSet)
...
bool UL1VitalSet::PreGameplayEffectExecute(FGameplayEffectModCallbackData& Data)
{
	...
	if (Data.EvaluatedData.Attribute == GetIncomingDamageAttribute())
	{
		if (Data.EvaluatedData.Magnitude > 0.0f)
		{
			...
			if (Data.Target.HasMatchingGameplayTag(L1GameplayTags::Cheat_GodMode) && bIsDamageFromSelfDestruct == false)
			{
				Data.EvaluatedData.Magnitude = 0.0f;
				return false;
			}
...
void UL1VitalSet::PostGameplayEffectExecute(const FGameplayEffectModCallbackData& Data)
{
...
void UL1VitalSet::PreAttributeBaseChange(const FGameplayAttribute& Attribute, float& NewValue) const
{
...
void UL1VitalSet::PreAttributeChange(const FGameplayAttribute& Attribute, float& NewValue)
{
...
void UL1VitalSet::PostAttributeChange(const FGameplayAttribute& Attribute, float OldValue, float NewValue)
{
...
void UL1VitalSet::ClampAttribute(const FGameplayAttribute& Attribute, float& NewValue) const
{
