...
#include "L1DeveloperSettings.generated.h"
...
class UL1DeveloperSettings : public UDeveloperSettingsBackedByCVars
{
	GENERATED_BODY()

public:
	UL1DeveloperSettings();
...
public:
	UPROPERTY(EditDefaultsOnly, BlueprintReadOnly, config, Category=L1)
	...
	UPROPERTY(EditDefaultsOnly, BlueprintReadOnly, config, Category="L1 Monster")
...
public:
	...
	L1GAME_API void OnPlayInEditorStarted() const;
