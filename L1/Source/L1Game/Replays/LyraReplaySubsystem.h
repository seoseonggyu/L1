...
class L1GAME_API ULyraReplayListEntry : public UObject
{
	GENERATED_BODY()
...
UCLASS(BlueprintType)
class L1GAME_API ULyraReplayList : public UObject
{
	GENERATED_BODY()
...
UCLASS()
class L1GAME_API ULyraReplaySubsystem : public UGameInstanceSubsystem
{
	GENERATED_BODY()
