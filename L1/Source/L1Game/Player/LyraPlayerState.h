 ...
 */
UCLASS(Config = Game)
class L1GAME_API ALyraPlayerState : public AModularPlayerState, public IAbilitySystemInterface, public ILyraTeamAgentInterface
{
	GENERATED_BODY()
...
private:
	...
	UPROPERTY()
	TObjectPtr<const class UL1StatSet> CombatSet;
