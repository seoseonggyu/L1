#include "L1ItemFragment_Equipable_Armor.h"

#include "Item/L1ItemInstance.h"
#include "UObject/ObjectSaveContext.h"

#include UE_INLINE_GENERATED_CPP_BY_NAME(L1ItemFragment_Equipable_Armor)

UL1ItemFragment_Equipable_Armor::UL1ItemFragment_Equipable_Armor(const FObjectInitializer& ObjectInitializer)
...
void UL1ItemFragment_Equipable_Armor::PreSave(FObjectPreSaveContext SaveContext)
{
...
void UL1ItemFragment_Equipable_Armor::OnInstanceCreated(UL1ItemInstance* ItemInstance) const
{
