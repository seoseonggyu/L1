...
struct L1GAME_API FLyraContextEffects
{
	GENERATED_BODY()
 ...
 */
UCLASS()
class L1GAME_API ULyraActiveContextEffects : public UObject
{
	GENERATED_BODY()
...
class L1GAME_API ULyraContextEffectsLibrary : public UObject
{
	GENERATED_BODY()
