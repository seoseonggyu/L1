#include "L1PickupableItemBase.h"
...
#include UE_INLINE_GENERATED_CPP_BY_NAME(L1PickupableItemBase)

AL1PickupableItemBase::AL1PickupableItemBase(const FObjectInitializer& ObjectInitializer)
...
void AL1PickupableItemBase::ProcessPickup()
{
	...
	{
		const UL1ItemTemplate* ItemTemplate = ItemTemplateClass->GetDefaultObject<UL1ItemTemplate>();
		PickupableMeshPath = ItemTemplate->PickupableMesh;
	}
...
void AL1PickupableItemBase::GetMeshComponents(TArray<UMeshComponent*>& OutMeshComponents) const
{
